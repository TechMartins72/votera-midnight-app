...
class Contract {
    ...
    this.circuits = {
      vote: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(_candidate_0),
        ...
        const result_0 = this.#_vote_0(context, partialProofData, _candidate_0);
  ...
  #_vote_0(context, partialProofData, _candidate_0) {
    let tmp_0;
